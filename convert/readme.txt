= How to convert an AGI game to Phasor =
...
moment on, the conversion to Phasor can be repeated without these steps.
...
If you're about to start convert all resources to Phasor, check to see that your 2-exported folder
...
several *.js and *.png files. Ready to be interpreted by Phasor!