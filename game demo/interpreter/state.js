...
var State =
{
  ...
  save: function() {
    ...
    document.title = "Phasor Savegame: " + AGI.game_id + " " + Phasor.getRoomName(AGI.current_room) + " score:" + Menu.score;
    ...
    Phasor.prevCheckForHashChange = Phasor.checkForHashChange;
    Phasor.checkForHashChange = function() { };
    ...
    Text.afterHideMessageHandler = function() {
      ...
      Phasor.checkForHashChange = Phasor.prevCheckForHashChange;
    }
  },
